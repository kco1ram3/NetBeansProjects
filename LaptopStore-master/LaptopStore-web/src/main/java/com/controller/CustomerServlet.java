...
public class CustomerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String str2 = request.getParameter("Nmsg");
        sendJMSMessageToDest(str2);
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>You just Login at time : " +Tbean.getTime()+"</h1>");
            out.println("<h2>"+"Your Name :"+str2+ "</h2>");
            out.println("<h2>"+"Your message :"+str+ "</h2>");
