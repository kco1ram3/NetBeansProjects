...
<c:url var="urlResetPwd" value="/ResetPass" />
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        <form method="POST" target="loginAction" action="${urlLogin}">
            <table align="center" style="font-size: small; border: black solid thin;">
                <caption style="background-color: black; color: white">Welcome to Web Security</caption>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="${urlResetPwd}">forgot password</a>
                    </td>
                </tr>
            </table>
        </form>
    ...
    <script>
        $(document).ready(function() {
            $("#password_login")
                    ...
                    .addTyping();
            $("#imgKeyboard,#password_login").click(function() {
